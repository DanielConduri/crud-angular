...
async function updateMetrics() {
    ...
    let { totalRuns, successCount, failureCount, startup_failure, cancelled, totalTimejobs } = await getData();

    let deployment_frequency = totalRuns;
    let lead_time = totalTimejobs / totalRuns;
    let mean_time_to_restore = 60;
    let change_failure_rate = failureCount / totalRuns * 100;
...
function calculateTime(created_at, updated_at) {
    ...
    // const created_at = "2025-01-14T05:53:39Z";
    // const updated_at = "2025-01-14T06:03:06Z";
